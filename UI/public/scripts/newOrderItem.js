    ...
    render: function() {
        return(
            <label className="radio-inline">
                <input type="radio" name={this.props.section} value={this.props.value} />{this.props.value}
            </label>
        );
    }
});
...
var PizzaCreatorSize = React.createClass({
    render: function() {
        ...
        this.props.sizes.forEach(function(size) {
            options.push(<RadioOption section="size" value={size.value} />);    
        });
        return(
            <div>
                <h3>Size</h3>
    ...
    render: function() {
        ...
        return(
            <div>
                ...
                <PizzaCreatorSize sizes={SIZES} /><hr/>
                <PizzaCreatorCrust crusts={CRUSTS} /><hr/>
